...
Revision ID: dfd1509da1ac
Revises: c8dbd00d0ef9
Create Date: 2026-08-25 20:08:29.602498
...
revision: str = 'dfd1509da1ac'
down_revision: Union[str, Sequence[str], None] = 'c8dbd00d0ef9'
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PANDING', 'PAID', 'CANCELLED', 'EXPIRED', name='orderstatus'), nullable=True),
